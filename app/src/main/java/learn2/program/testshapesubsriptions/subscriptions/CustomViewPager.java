...
public class CustomViewPager extends ViewPager {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setMaxWidth(ta.getDimensionPixelSize(R.styleable.CustomViewPager_android_maxHeight, -1));
        setMaxHeight(ta.getDimensionPixelSize(R.styleable.CustomViewPager_android_maxHeight, -1));
        setMatchChildWidth(ta.getResourceId(R.styleable.CustomViewPager_matchChildWidth, 100));
        ta.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mMaxWidth >= 0 || mMaxHeight >= 0) {
            ...
            widthMeasureSpec = MeasureSpec.makeMeasureSpec(
                    size.x, MeasureSpec.EXACTLY);
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(
                    size.y, MeasureSpec.EXACTLY);
        }
